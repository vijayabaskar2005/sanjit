...
function typeWriter() {
  if (i < txt1.length) {
     if(txt1.charAt(i)==='<')
      ...
      {
        $(".bg_heart").css("https://www.flaticon.com/free-icon/heart_833472")
      }
    else
